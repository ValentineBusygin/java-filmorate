...
public class UserTests {
    ...
    void userValidatesNullLogin() {
        User user = User.builder()
                ...
                .build();
        Set<ConstraintViolation<User>> violations = validator.validate(user);
        Assertions.assertEquals(1, violations.size(), "Не пройдена валидация на пустой или null логин");
    }
    ...
    void userValidatesNullEmail() {
        User user = User.builder()
                ...
                .build();
        Set<ConstraintViolation<User>> violations = validator.validate(user);
        Assertions.assertEquals(1, violations.size(), "Не пройдена валидация на пустой или null email");
    }
